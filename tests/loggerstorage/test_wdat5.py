...
class ConfigurationTestCase(TestCase):
    ...
    def test_valid_temperature_unit(self):
        MeteologgerStorage_wdat5(
            {"path": "irrelevant", "storage_format": "simple", "temperature_unit": "C"}
        )
    ...
    def test_valid_rain_unit(self):
        MeteologgerStorage_wdat5(
            {"path": "irrelevant", "storage_format": "simple", "rain_unit": "mm"}
        )
    ...
    def test_invalid_rain_unit(self):
        ...
        with self.assertRaisesRegex(ConfigurationError, msg):
            MeteologgerStorage_wdat5(
                {"path": "irrelevant", "storage_format": "simple", "rain_unit": "A"}
            )

    def test_valid_wind_speed_unit(self):
        MeteologgerStorage_wdat5(
            {"path": "irrelevant", "storage_format": "simple", "wind_speed_unit": "m/s"}
        )
    ...
    def test_valid_pressure_unit(self):
        MeteologgerStorage_wdat5(
            {"path": "irrelevant", "storage_format": "simple", "pressure_unit": "hPa"}
        )
    ...
    def test_invalid_pressure_unit(self):
        ...
        with self.assertRaisesRegex(ConfigurationError, msg):
            MeteologgerStorage_wdat5(
                {"path": "irrelevant", "storage_format": "simple", "pressure_unit": "A"}
            )
